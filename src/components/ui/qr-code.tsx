...
export const QRCode = ({ src }: { src: string }) => {
      ...
      <AnimatePresence mode="wait">
        {isOpen ? (
          ...
          <motion.button
            ...
            className="flex cursor-pointer items-center justify-center rounded-4xl border border-neutral-200 px-2 py-2 font-medium text-neutral-600 transition-all duration-300 ease-in-out hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-neutral-100"
          >
