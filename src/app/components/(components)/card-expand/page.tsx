...
import { CardExpand } from "@/registry/new-york/items/card-expand/components/card-expand";
...
export default function Page() {
  ...
  import { QRCode } from "@/components/card-expand";
  ...
  const commands = {
    pnpm: "pnpm dlx shadcn@latest add https://ui.cloffstudio.com/r/card-expand.json",
    npm: "npx shadcn@latest add https://ui.cloffstudio.com/r/card-expand.json",
    yarn: "yarn shadcn@latest add https://ui.cloffstudio.com/r/card-expand.json",
    bun: "bunx --bun shadcn@latest add https://ui.cloffstudio.com/r/card-expand.json",
  } as const;
  ...
  const propsData = [
    {
      ...
      type: "string",
      default: "undefined",
      description: "Title for the expanded card",
    },
    {
      prop: "description",
      type: "string",
      default: "-",
      description: "Description for the expanded card.",
    },
    {
      prop: "src",
      type: "string",
      default: "-",
      description: "URL or path to the image to display in the Card.",
    },
  ];
  ...
  return (
    <div>
      <Heading>Card Expand</Heading>
      <Para className="mt-4">
        Beautiful animated card expand component which shows title and
        description upon opening
      </Para>
      ...
      <PreviewRoot className="mt-10" defaultTab="preview">
        ...
        <PreviewContent value="preview">
          <CardExpand
            ...
            description="I don't know her but she looks cool."
          />
        </PreviewContent>
